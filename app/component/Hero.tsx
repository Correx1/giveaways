...
export default function Home() {
  ...
  return (
    <div>
      <div className="min-h-[50vh] bg-gradient-to-br from-green-900 via-emerald-800 to-teal-900 font-sans text-white flex flex-col">
        <header className="py-6 px-8 flex justify-between shadow-2xl">
          ...
          <div className="flex items-center gap-4">
            <Image src="/logo.jpg" alt="Logo" width={64} height={48} className="rounded-full" />
          </div>
        </header>
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <Image src="/OIP.jpg" alt="Giveaway Visual" width={400} height={100} className="rounded-xl shadow-2xl max-h-48 sm:max-h-64" />
          </motion.div>
